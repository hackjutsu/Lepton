module.exports = {
  ...
  editor: {
    ...
    dropLocalDraft: 'Drop draft',
    filenamePlaceholder: 'file name... (e.g. snippet.js)',
    invalidFilename: 'invalid filename',
    loadLocalDraft: 'Load draft',
    localDraftAvailable: 'Local draft available',
    localDraftCreatedAt: 'Created {{timestamp}}',
    localDraftLoaded: 'Local draft loaded',
    localDraftSubmitWarning: 'Submitting without loading the local draft will discard it.',
    removeFile: '#remove',
    required: 'required',
    secret: 'secret',
    submit: 'Submit',
