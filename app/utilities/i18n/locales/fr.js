module.exports = {
  ...
  editor: {
    ...
    dropLocalDraft: 'Supprimer le brouillon',
    filenamePlaceholder: 'nom du fichier... (ex. snippet.js)',
    invalidFilename: 'nom de fichier invalide',
    loadLocalDraft: 'Charger le brouillon',
    localDraftAvailable: 'Brouillon local disponible',
    localDraftCreatedAt: 'Cree le {{timestamp}}',
    localDraftLoaded: 'Brouillon local charge',
    localDraftSubmitWarning: 'Envoyer sans charger le brouillon local le supprimera.',
    removeFile: '#retirer',
