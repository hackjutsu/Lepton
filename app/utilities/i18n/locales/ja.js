module.exports = {
  ...
  dashboard: {
    ...
    notEnoughData: 'データが不足しています。3種類以上の言語でスニペットを作成してみてください。Happy Coding!',
    statsLabel: '言語統計',
    title: 'ダッシュボード'
  },
  dialog: {
  ...
  editor: {
    ...
    dropLocalDraft: '下書きを破棄',
    filenamePlaceholder: 'ファイル名...（例: snippet.js）',
    invalidFilename: '無効なファイル名',
    loadLocalDraft: '下書きを読み込む',
    localDraftAvailable: 'ローカル下書きがあります',
    localDraftCreatedAt: '作成日時: {{timestamp}}',
    localDraftLoaded: 'ローカル下書きを読み込みました',
    localDraftSubmitWarning: 'ローカル下書きを読み込まずに送信すると、その下書きは破棄されます。',
    removeFile: '#削除',
    required: '必須',
    secret: 'シークレット',
    submit: '送信',
  ...
  menu: {
    ...
    minimize: '最小化',
    newGist: '新規スニペット',
    openLeptonWindow: 'Leptonウィンドウを開く',
    openWindow: 'ウィンドウを開く',
    quit: '終了',
    quitLepton: 'Leptonを終了',
    search: '検索',
    speech: 'スピーチ',
    submitGist: 'スニペットを送信',
    syncGist: 'スニペットを同期',
  ...
  snippet: {
    ...
    delete: '削除',
    deleteAction: '削除',
    deleteConfirmTitle: 'このスニペットを削除しますか？',
    edit: '編集',
  ...
  welcome: {
    emptySnippet: '左パネルの#newをクリックしてスニペットを作成してください。'
  }
}
