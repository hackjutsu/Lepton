module.exports = {
  ...
  dashboard: {
    ...
    notEnoughData: '데이터가 부족합니다. 두 가지가 넘는 언어의 스니펫을 만들어 보세요. Happy Coding!',
    statsLabel: '내 언어 통계',
    title: '대시보드'
  },
  dialog: {
  ...
  editor: {
    ...
    dropLocalDraft: '초안 버리기',
    filenamePlaceholder: '파일 이름... (예: snippet.js)',
    invalidFilename: '잘못된 파일 이름',
    loadLocalDraft: '초안 불러오기',
    localDraftAvailable: '로컬 초안 사용 가능',
    localDraftCreatedAt: '{{timestamp}}에 생성됨',
    localDraftLoaded: '로컬 초안을 불러왔습니다',
    localDraftSubmitWarning: '로컬 초안을 불러오지 않고 제출하면 해당 초안이 삭제됩니다.',
    removeFile: '#제거',
    required: '필수',
    secret: '비공개',
    submit: '제출',
  ...
  menu: {
    ...
    minimize: '최소화',
    newGist: '새 스니펫',
    openLeptonWindow: 'Lepton 창 열기',
    openWindow: '창 열기',
    quit: '종료',
    quitLepton: 'Lepton 종료',
    search: '검색',
    speech: '말하기',
    submitGist: '스니펫 제출',
    syncGist: '스니펫 동기화',
  ...
  snippet: {
    ...
    delete: '삭제',
    deleteAction: '삭제',
    deleteConfirmTitle: '이 스니펫을 삭제할까요?',
    edit: '편집',
  ...
  welcome: {
    emptySnippet: '왼쪽 패널의 #new를 클릭해 스니펫을 만드세요.'
  }
}
