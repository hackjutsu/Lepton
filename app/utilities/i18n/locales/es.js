module.exports = {
  ...
  editor: {
    ...
    dropLocalDraft: 'Descartar borrador',
    filenamePlaceholder: 'nombre de archivo... (ej. snippet.js)',
    invalidFilename: 'nombre de archivo invalido',
    loadLocalDraft: 'Cargar borrador',
    localDraftAvailable: 'Borrador local disponible',
    localDraftCreatedAt: 'Creado {{timestamp}}',
    localDraftLoaded: 'Borrador local cargado',
    localDraftSubmitWarning: 'Enviar sin cargar el borrador local lo descartara.',
    removeFile: '#eliminar',
